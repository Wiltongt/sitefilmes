...
document.addEventListener('DOMContentLoaded', function() {
    // Ações para botões CTA (agora links diretos)
    // Não é necessário um event listener para redirecionamento, pois os links HTML já fazem isso.
    // Apenas para efeitos visuais, se desejar:
    // const ctaButtons = document.querySelectorAll(".cta-btn");
    // ctaButtons.forEach(button => {
    //     button.addEventListener("click", function(e) {
    //         // e.preventDefault(); // Remova esta linha para permitir o redirecionamento direto
